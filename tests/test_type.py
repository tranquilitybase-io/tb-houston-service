...
url = f"http://{HOUSTON_SERVICE_URL}/api/type/"
...
def post():
    ...
    # Test POST Then GET
    # Body
    payload = {"id":0, "value": "test-post-type"}
    ...
    assert resp_json["value"] == "test-post-type"
...
def put(id):
    ...
    newpayload = {"id": int(id), "value": "new-test-type"}
    resp = requests.put(
    ...
    assert resp_json["value"] == "new-test-type"
