...
url = 'http://localhost:3000/api/landingzoneprogressitem/'
...
def put(id):
    ...
    newpayload = { 'completed': False, 'id': int(id), 'label': 'Testing' }
...
def get_all():
    ...
    url = 'http://localhost:3000/api/landingzoneprogressitems/'
